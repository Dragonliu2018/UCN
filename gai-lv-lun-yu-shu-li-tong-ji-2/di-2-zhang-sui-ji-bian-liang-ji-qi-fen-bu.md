...
* **定义**：设连续型r.v.X的概率密度为：$$f(x)= \frac{1}{\sqrt{2π}σ} e^{\frac{-(x-μ)^2}{2σ^2}}，-\infty<x<+\infty$$ ，其中μ、σ\(σ&gt;0\)为常数，则称X服从参数为μ、σ的正态分布，记作 $$X\sim N(μ, σ^2)$$ 
...
* **转换**： 若 $$X\sim N(μ, σ^2)$$ ，则 $$Z = \frac{X-μ}{σ} = N\sim(0,1)$$ 
* 3σ原则：0.997
* **查表**
