...
1. **出题**：$$\frac{2010}{128} 转二进制或十六进制$$ ：2010用到快速转换\(2048 - 38 = 2047 - 37\)得到0111 1101 1010，再除以一个128\( $$2^7$$ \)是小数点向左移动7位得 0111 1.101 1010，转十六进制注意补零得4.B4。
2. R进制转十进制：按权展开
...
1. **字长\(用来指明整数和指针的标称大小\)**决定虚拟地址空间的大小。
2. 字表示被处理信息的单位，用来度量数据类型的宽度。
