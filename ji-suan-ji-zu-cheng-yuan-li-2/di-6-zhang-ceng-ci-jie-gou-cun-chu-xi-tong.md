...
1. 指令 $$I$$ 线性地址： $$0x0 +0x8049c08=0x8049c08$$ CS对应的段描述符中的基地址与指令地址相加 页大小 $$4KB=2^{12}B$$ ，页内偏移量为低12位\(0xc08 = 3080\)，高20位为虚页号\(0x08049 = 32841‬\)；其中高10位是页目录索引\(0x20 = 32\)，低10位是页表索引\(0x49 = 73\) 不可能 页故障线性地址：0x804d000；CR2\(页故障线性地址寄存器\)
